...
// 获取全局应用程序实例对象
var app = getApp();
var md5 = require('../../utils/wxmd5');
var upng = require('../../utils/UPNG.js');
var app_key = 'VTtsGXNXUeTqzIBX';
var app_id = 1106941934;
// 创建页面实例对象
Page({
  /**
   * 页面的初始数据
    ...
    if (choose === this.data.videoArr.length) {
      var ojbs = {
        ...
        success: function success(res) {
          ...
          try {
            for (var _iterator = res.data.data.data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              var i = _step.value;
